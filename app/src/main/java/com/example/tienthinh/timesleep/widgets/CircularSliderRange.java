package com.example.tienthinh.timesleep.widgets;
...
public class CircularSliderRange extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int thumbColor = a.getColor(R.styleable.CircularSlider_start_thumb_color, GRAY);
        int thumbEndColor = a.getColor(R.styleable.CircularSlider_end_thumb_color, GRAY);
        ...
        int borderColor = a.getColor(R.styleable.CircularSlider_border_color, RED);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Shader shader = new LinearGradient(0, 0, 0, 10 /*canvas height*/, getResources().getColor(R.color.textColor), Color.rgb(36,36,36), Shader.TileMode.CLAMP /*or REPEAT*/);
//        mPaint.setColor(mBorderColor);
        ...
        //mLinePaint.setColor(mArcColor == 0 ? RED : mArcColor);
        mLinePaint.setColor(getResources().getColor(R.color.textWakeUp));
